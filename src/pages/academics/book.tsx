  ...
  return (
    <>
      ...
      <div className="flex md:justify-around  w-full min-h-full flex-wrap  md:flex-row flex-col justify-center items-center   ">
        <BookHeading
          iconeName={<GoTelescope />}
          title={'First'}
          bookDetail={firstData}
        />
        <BookHeading
          iconeName={<FaGuitar />}
          title={'Second'}
          bookDetail={secoundData}
        />
        <BookHeading
          iconeName={<GiEvilTower />}
          title={'Third'}
          bookDetail={thirdData}
        />
      </div>
      <div className="flex md:justify-around  flex-wrap  md:flex-row flex-col justify-center items-center   ">
        <BookHeading
          iconeName={<IoMdSchool />}
          title={'Four'}
          bookDetail={fourData}
        />
      ...
      <div className="flex md:justify-around   flex-wrap  md:flex-row flex-col   ">
        <BookHeading
          iconeName={<GiTrophyCup />}
          title={'Seven'}
          bookDetail={sevenData}
        />
        <BookHeading
          iconeName={<HiBuildingOffice2 />}
          title={'Eight'}
          bookDetail={eightData}
        />
