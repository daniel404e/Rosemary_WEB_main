...
import pic2 from '../../images/gallery/2.webp'
import pic3 from '../../images/gallery/3.webp'
import newPic from '../../images/sports/2.png'
import pic5 from '../../images/gallery/5.jpg'
import pic6 from '../../images/gallery/6.jpg'
import pic7 from '../../images/gallery/7.webp'
import pic8 from '../../images/gallery/8.png'
                  ...
                  >
                    <div className="effect effect-nine">
                      <Image
                        ...
                        height={400}
                        src={item.src}
                        className="img-fluid w-[400px] h-[400px]"
                        alt="image"
                      />
