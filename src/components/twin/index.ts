...
export const GrayText = tw.p`leading-relaxed font-bold text-justify w-2/3 text-[#888] mt-5 text-[12px]  md:text-base lg:text-[1.2rem]`
...
export const InputSet = tw.div`w-full px-3 mb-6 pb-6  md:mb-0`
