...
const index = () => {
  ...
  const styled = 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5'
  return (
    <>
        ...
        <div className="grid overflow-hidden grid-cols-1 grid-rows-8 md:grid-cols-2 md:grid-rows-4 lg:grid-cols-4 lg:grid-rows-2 gap-1.5">
          <div className="box p-1 ">
            <Field
              type="text"
           name='childName'
           style={getStyles(errors, `childName`)}
              className={styled}
          ...
          <div className="box p-1">
            <Field
              type="text"
              name='parentName'
              style={getStyles(errors, `parentName`)}
              className={styled}
          ...
          <div className="box p-1">
            <Field
              type="text"
              name='comment'
              style={getStyles(errors, `comment`)}
          ...
          <button onClick={() => handleSubmit()} className="w-fit h-10 rounded-md bg-secondary px-5 text-white mt-4 ml-2 ">
            Enroll
          </button>
        </div>
      </div>
